...
public abstract class WindowSetup {
    ...
    // VARSAYILAN KESİNLİKLE TOP|LEFT OLMALI
    ...
    static void setNotificationVisibility(String name) {
        if (name.equalsIgnoreCase("visibilityPublic")) { notificationVisibility = NotificationCompat.VISIBILITY_PUBLIC;
        } else if (name.equalsIgnoreCase("visibilitySecret")) { notificationVisibility = NotificationCompat.VISIBILITY_SECRET;
        } else { notificationVisibility = NotificationCompat.VISIBILITY_PRIVATE; }
    }

    static void setFlag(String name) {
        int baseFlags = WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN | WindowManager.LayoutParams.FLAG_LAYOUT_INSET_DECOR;
        if (name.equalsIgnoreCase("flagNotFocusable") || name.equalsIgnoreCase("defaultFlag")) {
            ...
            flag = baseFlags | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE | WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE;
        ...
        } else { flag = baseFlags | WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE; }
    }
    ...
    static void setGravityFromAlignment(String alignment) {
        ...
        else if (alignment.equalsIgnoreCase("centerLeft")) gravity = Gravity.CENTER_VERTICAL | Gravity.LEFT;
        else if (alignment.equalsIgnoreCase("center")) gravity = Gravity.CENTER;
        else if (alignment.equalsIgnoreCase("centerRight")) gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
        else if (alignment.equalsIgnoreCase("bottomLeft")) gravity = Gravity.BOTTOM | Gravity.LEFT;
        else if (alignment.equalsIgnoreCase("bottomCenter")) gravity = Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL;
        else if (alignment.equalsIgnoreCase("bottomRight")) gravity = Gravity.BOTTOM | Gravity.RIGHT;
    }
}
